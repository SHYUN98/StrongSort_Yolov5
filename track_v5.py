...
def run(
    ...
    temp_path = os.path.join('C:/Users/rosha\Desktop/tad-IROS2019-master/deep_sort_clear/' + name +'.npy')
    ...
    for frame_idx, (path, im, im0s, vid_cap, s) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            txt_path = str('C:/Users/rosha/Desktop/tad-IROS2019-master/deep_sort_clear/')  # im.txt
